...
<body>
    <div class="container">
            ...
            <?php if($event->location_type === 'venue' && $event->location): ?>
                <div class="event-info">
                    ...
                    <?php if(!empty($event->location['address'])): ?>
                        - <?php echo e($event->location['address']); ?><?php if(!empty($event->location['city'])): ?>, <?php echo e($event->location['city']); ?><?php endif; ?>
                    <?php endif; ?>
                </div>
        ...
        <div class="section-title">Your Tickets (<?php echo e($ticketItems->count()); ?>)</div>
            ...
            <?php $__currentLoopData = $ticketItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ticket-item">
                    ...
                    <div class="ticket-info">
                        <span class="ticket-attendee"><?php echo e($item->attendee_name ?: $order->customer_name); ?></span>
                        <span class="ticket-type">
                            -
                            <?php if($item->ticketTier): ?>
                                <?php echo e($item->ticketTier->name); ?>

                            <?php elseif($item->table && $item->seat): ?>
                                <?php echo e($item->table->name); ?> · Seat <?php echo e($item->seat->label); ?>

                            <?php elseif($item->table): ?>
                                <?php echo e($item->table->name); ?>

                            <?php else: ?>
                                <?php echo e($item->item_name ?: 'General Admission'); ?>
...
<?php /**PATH /var/www/html/resources/views/emails/order-tickets.blade.php ENDPATH**/ ?>